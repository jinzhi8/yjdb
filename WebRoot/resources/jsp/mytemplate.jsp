...
<%!//根据id获取模块输出
String getFuncHTML(String id, String wid, String templatename, String layouttype, String username, String topicname, String topicurl, String align, String userflag, String contextPath) {
	...
	if (align.equals("left")) {
		...
		return "<tr><td><table border=\"0\"  width=\"890\" height=1 cellspacing=\"0\" cellpadding=\"0\"  align=center><tr><td colspan=2 height=5 background=../resources/theme/images/pan_top.gif><table border=\"0\"  height=1 width=100% cellspacing=\"0\" cellpadding=\"0\" align=right background=../img/pan_top.gif><tr><td width=1><img src=../img/pan_0.gif></td><td width=\'\'><span class=\"ziti \">" + topicname + "</span></td><td width=1><img src=../img/pan_3.gif></td></tr></table></td></tr><tr><td style=\"BORDER-left: #cccccc 1px solid;BORDER-right: #cccccc 1px solid;BORDER-bottom: #cccccc 1px solid;background-color:DDDDDD\" valign=top><table border=\"0\"  width=100% height=1 cellspacing=\"0\" cellpadding=\"0\"  align=center><tr><td width=3></td><td height=100 style=\"BORDER-left: #cccccc 1px solid;BORDER-right: #cccccc 1px solid;BORDER-bottom: #cccccc 1px solid;background-color:#ffffff\"><table border=\"0\"  width=100% height=1 cellspacing=\"0\" cellpadding=\"0\"  align=center><tr><td height=1 bgcolor=cccccc></td></tr><tr><td height=1 valign=top><table border=\"0\"  width=100% height=1 cellspacing=\"0\" cellpadding=\"5\"  align=center><tr><td><iframe id=\"" + id + "\" height=\"" + ihid + "\" src=\"" + topicurl + "\" width=\"100%\" frameBorder=\"0\" scrolling=\"no\"></iframe></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td></tr>";
...
<table border="0" width=100% height=1 cellspacing="0" cellpadding="0" align=center>
	<tr>
		<td width='' background=<%=request.getContextPath()%>/img/top_bg.gif>
			<img src=<%=request.getContextPath()%>/img/logo.gif></td>

	</tr>
	<tr>
		<td height=1 colspan=10 bgcolor=935313></td>
	</tr>
	<tr>
		...
		<td width="1">
			<table width=300 border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="30" align=center onClick="javascript:parent.location.href='index.htm'" style="cursor:hand">
						<img border="0" src="<%=request.getContextPath()%>/img/top_home.gif"></td>
					<td width="24" style="cursor:hand">
						<img border="0" src="<%=request.getContextPath()%>/img/top_message.gif"></td>
					<td width="28" onClick="javascript:window.location.reload()" style="cursor:hand">
						<img border="0" src="<%=request.getContextPath()%>/img/top_reflash.gif"></td>

					<td width="30" align=center onClick="javascript:window.location.href='login.htm'" style="cursor:hand">
						<img border="0" src="<%=request.getContextPath()%>/img/top_logout.gif"></td>
				</tr>
			</table>
		</td>
	</tr>
...
<table border="0" width=100% height="1" cellspacing="0" cellpadding="0" align=center>
	<tr>
		...
		<td width=180 valign=top align=center>
			<table border="0" width=100% height=1 cellspacing="0" cellpadding="0" align=center>
				<tr>
					<td height=23 background=<%=request.getContextPath()%>/img/tool_top.gif><b>&nbsp;应用模块导航</td>
				</tr>
				<tr>
					<td height=280 class=tool align=left valign="top">
						<table>
							...
							<tr>
								<td align="left">
									<a href="javascript:void(1)" onClick="display('submenu',<%=i%>);"><%=menuName%>
									</a></td>
							</tr>
							<tr>
								<td>
									<div id="submenu<%=i%>" style="display:none">
										<table>
											...
											<tr>
												<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=submenuLink%>"><%=submenuName%>
												</a></td>
											</tr>
											<% }%>
										</table>
				...
				<tr>
					<td height=1><img src=<%=request.getContextPath()%>/img/tool_bot.gif></td>
				</tr>
				<tr>
					<td height=5><% //左栏标题
						...
						if (havedata) {
							do {
								...
								if (layouttype == 0) {
									...
									//是否功能栏目
									if (isFunc(topicid)) {
										//out.print(getFuncHTML(topicid,"185",templatename,"0",usernameen,topicname,topicurl,"left",userflag),contextPath);
										leftdivstr += getFuncHTML(topicid, "185", templatename, "0", usernameen, topicname, topicurl, "left", userflag, contextPath);
										havedata = rs.next();
									} else {
										havedata = rs.next();
									}
				...
				<tr>
					<td height=25 background=<%=request.getContextPath()%>/img/tool_top.gif><b>&nbsp;日历</td>
				</tr>
				<tr>
		...
		<td width="180" valign=top>
			...
			<table border="0" width=100% height=1 cellspacing="0" cellpadding="0" align=center>
				<tr>
					<td height=23 background=<%=request.getContextPath()%>/img/tool_top.gif><b>&nbsp;公告</td>
				</tr>
				<tr>
					<td height=120 class=tool align=center>
						<iframe height="150" src="<%=request.getContextPath()%>/sharebulletin/info.jsp" width="100%" frameBorder="0" scrolling="no"></iframe>
					</td>
				</tr>
				<tr>
					<td height=1><img src=<%=request.getContextPath()%>/img/tool_bot.gif></td>
				...
				<tr>
					<td height=25 background=<%=request.getContextPath()%>/img/tool_top.gif><b>&nbsp;个人办公</td>
				</tr>
				<tr>
					<td height=180 class=tool valign=top>
						<table border="0" width=100% height=1 cellspacing="4" cellpadding="0">
							<tr>
								<td>
									<%=leftdivstr%>
								</td>
				...
				<tr>
					<td height=23 background=<%=request.getContextPath()%>/img/tool_top.gif><b>&nbsp;常用工具</td>
				</tr>
				<tr>
					<td height=120 class=tool valign=top>
						<table border="0" width=100% height=1 cellspacing="4" cellpadding="0">
							<tr>
								<td>·<a href="http://www.wenzhou.gov.cn">温州市政府</a></td>
							</tr>
							<tr>
								<td>·<a href="http://www.sina.com.cn/">新浪网</a></td>
							</tr>
							<tr>
								<td>·<a href="http://www.gov.cn/">中国政府网</a></td>
							</tr>
							<tr>
								<td>·<a href="http://www.google.cn">Google搜索</a></td>
							</tr>
						</table>
