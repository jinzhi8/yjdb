...
<head>
	...
	<script language="javascript" type="text/javascript" charset="utf-8" src="<%=contextPath%>/resources/js/wskzm/wskzm.js"></script>
...
<script>
	function showAttach(uuid){
		window.showModalDialog('<%=request.getContextPath()%>/resources/jsp/signature/showAttach.jsp?uuid='+uuid,window,'status:no;dialogWidth:980px;dialogHeight:600px;scroll:no;help:no;');
	}
</script>
...
<object id='cebWebOfficeObjPrint' height='0' width='0' style='display:none;' classid='clsid:E77E049B-23FC-4DB8-B756-60529A35FAD5'></OBJECT>
</body>
</html><!--索思奇智版权所有-->