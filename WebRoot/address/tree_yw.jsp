		...
		<td>
			<div style="width:100%;height:360px;overflow:auto">
				<script type="text/javascript">
                    ...
                    <%
                    Activity curActivity = WorkflowFactory.getActivityManager().getActivity(activid);
                    if(curActivity==null||StringHelper.isNull(curActivity.getPerformerPurview())){
                    %>
					
                    <%}%>
					document.write(new WebFXLoadTree("本单位","userTreeNew.do?utype=<%=utype%>&range=<%=rangeList%>&rolecode=<%=rolecode%>"));
