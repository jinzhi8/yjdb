...
<template:insert template="<%=userTemplateStr%>">
	...
	<template:put name='content'>
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" class="round" style="width:100%;height:100%;position:absolute">
			<tr>
				<td class="left_col leftvcd" valign="top">
					<iframe frameborder="0" scrolling="auto" name="mframe" src="nav2.jsp" style="width:100%;height:100%;"></iframe>
				</td>
