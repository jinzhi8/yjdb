...
(function ($) {
        ...
        renderData: function (R, $grid, cyProps) {
            ...
            var outHtml =
                _grid.html([
                    ...
                    '<button type="button" title="右移" lay-name="' + _name + '" class="layui-btn layui-btn-normal layui-btn-sm layui-btn-disabled"><i class="layui-icon">&#xe65b;</i></button>',
                    '</div>',
                    '<div class="transfer-btn  transfer-to-left">',
                    '<button type="button" title="左移" lay-name="' + _name + '"  class="layui-btn layui-btn-normal layui-btn-sm layui-btn-disabled"><i class="layui-icon">&#xe65a;</i></button>',
                    '</div>',
    ...
    $(document).on("click", ".transfer-to-right", function () {
        var $this = $(this);
        var _name = $this.find('button').attr("lay-name") || "";
