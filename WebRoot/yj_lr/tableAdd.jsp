...
<head>
    <%
        ...
        String dataObj = "";
        String attach = "";
        String hsz = CommonUtil.doStr(request.getParameter("hsz"));
        if (!unid.equals("")) {
            String module = "yj_lr";
            if (!"".equals(hsz))
                module = "yj_lr_hsz";
            Map<String, Object> map = MyDBUtils.queryForUniqueMapToUC("select * from " + module + " where unid=?", unid);
    ...
    <link rel="stylesheet" href="layui-formSelects/dist/formSelects-v4.css" media="all"/>
    <link rel="stylesheet" href="../css/public.css" media="all"/>
    <script type="text/javascript" src="../js/layui/layui.js"></script>
    <script type="text/javascript" src="../js/jquery-1.11.0.min.js"></script>
    <script type="text/javascript" src="../js/jquery.easyui.min.js"></script>
    <script language="javascript" type="text/javascript" charset="utf-8"
            src="../yj_lr/tableAdd.js?v=<%=Math.random()%>"></script>
    <script>
        var dataObj = <%=dataObj%>;
        var nowtime = "<%=nowtime%>";
        var action = "<%=action%>";
...
<form class="layui-form layui-form-pane" action="<%=contextPath%>/yj_common/save.jsp" id="infoform"
    ...
    <input type="hidden" name="ishy" value="0"/>
    ...
    <div class="newclass-nytopboxs">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block mySelect" id="test">
                ...
                <input type="text" name="title" id="title" lay-verify="required" placeholder="请输入督办件名称"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <label class="layui-form-label"><i class="hongdian">*</i>批示领导</label>
                <div class="layui-input-inline">
                    <%if (admin) {%>
                    <select readonly name="pspersonid" lay-filter="pspersonid"></select>
                    <input type="hidden" name="psperson">
                    <%} else {%>
                    <input type="text" class="layui-input l-text" lay-verify="required" name="psperson" readonly="true"
                           placeholder="请选择批示领导">
                    ...
                    <input type="text" name="pspersonid" style="display:none">
                    <%}%>
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <%} else {%>
                    <input type="text" class="layui-input l-text" lay-verify="" name="qtperson" readonly="true"
                           placeholder="请选择牵头领导">
                    <img class="l-img" title="点击选择处理人" src="<%=request.getContextPath()%>/resources/images/actn133.gif"
                         onclick="openSelWinNew('<%=request.getContextPath()%>/address/tree_ry.jsp?utype=1&sflag=0&count=1&fields=qtperson,qtpersonid');">
                    <input type="text" name="qtpersonid" style="display:none">
                    <%}%>
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <%} else {%>
                    <input type="text" class="layui-input l-text" name="phperson" readonly="true" placeholder="请选择配合领导">
                    <img class="l-img" title="点击选择处理人" src="<%=request.getContextPath()%>/resources/images/actn133.gif"
                         onclick="openSelWinNew('<%=request.getContextPath()%>/address/tree_ry.jsp?utype=1&sflag=0&count=0&fields=phperson,phpersonid');">
                    <input type="text" name="phpersonid" style="display:none">
                    <%}%>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input time" readonly name="createtime" value="<%=nowtime%>">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label"><i class="hongdian">*</i>交办时限</label>
                <div class="layui-input-inline">
                    <input type="text" class="layui-input time" readonly lay-verify="required" name="jbsx"
                           placeholder="请填写交办时限">
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="fklx" title="一次性反馈" lay-skin="primary" lay-filter="fklx" value="1"
                           checked/>
        ...
        <div id="sfscrwnr" style="display: none">
            <div class="layui-form-item">
                ...
                <input type="radio" name="sfscrwnr" title="否" lay-skin="primary" lay-filter="sfscrwnr" value="0"
                       checked/>
        ...
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label"><i class="hongdian">*</i>批示内容</label>
            <div class="layui-input-block">
                <textarea placeholder="请输入督办内容" name="details" class="layui-textarea" lay-verify="required"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <table style='width:100%;' class="table01" id="return1">
                <input type="hidden" id="trnum1" name="trnum" value="0">
                <tr>
                    <TD VALIGN=middle style="width:90%;font-size:14px;">
                        <DIV ALIGN=center>再次批示</DIV>
                    </TD>
                    <TD VALIGN=middle style="width:10%;font-size:14px;">
                        <DIV ALIGN=center>发布时间</DIV>
                    </TD>
                    <TD VALIGN=middle class="deeptd">
                        <a class="layui-btn layui-btn-sm" onclick="addCount(1);"><i
                                class="layui-icon">&#xe654;</i>新增</a>
                    </TD>
                </tr>
            </table>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input l-text" name="qtdepname" readonly="true" placeholder="请选择牵头单位"
                       lay-verify="">
                <%-- <img class="l-img" title="点击选择处理人" src="<%=request.getContextPath()%>/resources/images/actn133.gif"
                     onclick="openSelWinNew('<%=request.getContextPath()%>/address/tree_jg.jsp?utype=0&rtype=0&ptype=0&sflag=0&count=0&fields=qtdepname,qtdepnameid');"> --%>
                <img class="l-img" title="点击选择处理人" src="<%=request.getContextPath()%>/resources/images/actn133.gif"
    ...
    <div class="newclass-nytopboxs">
        <div class="layui-form-item">
            <%-- <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="lxrname" lay-verify="" placeholder="请输入督办联系人" class="layui-input"
                           value="<%=userName%>">
                </div>
            </div> --%>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <%} else {%>
                    <input type="text" class="layui-input l-text" lay-verify="required" name="lxrname" readonly="true"
                           placeholder="请选择督办联系人">
                    <img class="l-img" title="点击选择处理人" src="<%=request.getContextPath()%>/resources/images/actn133.gif"
                         onclick="openSelWinNew('<%=request.getContextPath()%>/address/tree_ry.jsp?utype=1&sflag=0&count=1&fields=lxrname,lxrnameid');">
                    <input type="text" name="lxrnameid" style="display:none">
                    <%}%>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">手机号码</label>
                    <div class="layui-input-inline">
                        <input type="text" name="lxrmobile" lay-verify="" <%if(admin){%>value="<%=lxrmobile%>"<%}%>
                               placeholder="请输入督办联系人号码" class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">短号</label>
                    <div class="layui-input-inline">
                        <input type="text" name="lxrshort" lay-verify="" <%if(admin){%>value="<%=lxrshort%>"<%}%>
                               placeholder="请输入督办联系人短号" class="layui-input">
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="radio" name="dstatus" title="是" lay-skin="primary" lay-filter="dstatus" value="1"
                               checked/>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <a class="layui-btn layui-btn-xs" onclick="getMb();"><i
                        class="layui-icon layui-icon-edit"></i>生成短信模板</a>
            </div>
            <div class="layui-form-item  mb">
                <label class="layui-form-label"></i><i class="hongdian">*</i>领导模板</label>
                <div class="layui-input-block">
                    <input type="text" class="layui-input" lay-verify="required" name="ldmb" id="ldmb" placeholder=""
                           value="">
                </div>
            </div>
            <div class="layui-form-item  mb">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input" lay-verify="required" name="dwmb" id="dwmb" placeholder=""
                           value="">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item bottom-btn-wrap">
                ...
                <div>
                    ...
                    <submit class="layui-btn layui-btn-normal" lay-submit="" lay-filter="button"
                            onclick="setFlag('0');">保存草稿
                    </submit>
                    <% } %>
                    <submit class="layui-btn" lay-submit="" lay-filter="button" onclick="setFlag('1');">立即提交</submit>
                    <%if (!unid.equals("") && !"qxgq".equals(action)) {%>
                    <submit class="layui-btn layui-btn-warm" lay-submit="" lay-filter="newbutton"
                            onclick="setFlag('1');">重新发布
                    </submit>
                    <%}%>
                </div>
                <%}%>
