...
<%!String getFuncHTML(String contextPath, String id, String wid, String templatename, String layouttype, String username, String topicname, String topicurl, String align, String userflag) {
	...
	if (align.equals("left")) {
		if (id.indexOf("datalink") > 0) { //资料库链接 注释
			...
			return "<tr><td>&nbsp;&nbsp;<a href=\'" + contextPath + topicurl + "\' " + newWindow + ">" + topicname + "</a></td></tr>";
		}
	} else {
...
<table id="alltable" width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="my_home" class="border-index">
	<tr>
		...
		<td width="185px" valign="top" style="width:180px;padding-left:4px;padding-right:4px;padding-bottom:3px" align="center">
			<table border='0' width=100% height='1' cellspacing='0' cellpadding='0' align=center>
				<tr>
					<td colspan=2 height=5 bgcolor='#DDDDDD'>
						<table border='0' height='1' width=100% cellspacing='0' cellpadding='0' align=right background='<%=contextPath%>/resources/jsp/images/pan_top.gif'>
							<tr>
								<td width=1><img alt='' src='<%=contextPath%>/resources/jsp/images/pan_0.gif'></td>
								<td>&nbsp;<b><!--标题-->公告</b></td>
								<td width=1><img alt='' src='<%=contextPath%>/resources/jsp/images/pan_3.gif'></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td style='BORDER-left: #cccccc 1px solid;BORDER-right: #cccccc 1px solid;BORDER-bottom: #cccccc 1px solid;background-color:#DDDDDD' valign=top>
						<table border='0' width=100% height='1' cellspacing='0' cellpadding='0' align=center>
							<tr>
								<td width=3></td>
								<td height=100 style='BORDER-left: #cccccc 1px solid;BORDER-right: #cccccc 1px solid;BORDER-bottom: #cccccc 1px solid;background-color:#ffffff'>
									<table border='0' width=100% height='1' cellspacing='0' cellpadding='0' align=center>
										<tr>
										...
										<tr>
											<td><!--正文-->
												<iframe onload="if(this.contentDocument&&this.contentDocument.body.offsetHeight){this.height=this.contentDocument.body.offsetHeight;}else if(this.Document&&this.Document.body.scrollHeight){this.height=this.Document.body.scrollHeight;}" height="150" src="<%=contextPath%>/sharebulletin/info.jsp" width="100%" frameBorder="0" scrolling="no"></iframe>
											</td>
										</tr>
									</table>
								</td>
							...
							<tr>
								...
								<td height=100 style='BORDER-left: #cccccc 1px solid;BORDER-right: #cccccc 1px solid;BORDER-bottom: #cccccc 1px solid;background-color:#ffffff'>
									<table border='0' width=100% height='1' cellspacing='0' cellpadding='0' align=center>
										...
										<tr>
											<td style='padding-top:5px;padding-buttom:5px'><!--正文-->
												<table><%=leftshowstr%>
												</table>
											</td>
										</tr>
							...
							<tr>
								...
								<td height=100 style='BORDER-left: #cccccc 1px solid;BORDER-right: #cccccc 1px solid;BORDER-bottom: #cccccc 1px solid;background-color:#ffffff'>
									<table border='0' width=100% height='1' cellspacing='0' cellpadding='0' align=center>
										...
										<tr>
											<td><!--正文-->
												<iframe onload="if(this.contentDocument&&this.contentDocument.body.offsetHeight){this.height=this.contentDocument.body.offsetHeight;}else if(this.Document&&this.Document.body.scrollHeight){this.height=this.Document.body.scrollHeight;}" id="func_datalink" height="" src="<%=contextPath%>/share/shatedowp.jsp" width="100%" frameBorder="0" scrolling="no"></iframe>
											</td>
										</tr>
									</table>
								</td>
