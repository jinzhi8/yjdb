...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="chart-list">
            ...
            <div class="block">
                <div id="dbclass_0" class="block-content supervise">
                    <div class="left">
                        <em>今年总督办件数</em>
                        <label><b id="dbjs_0"></b>件</label>
                        <!--  <i class="updown" id="dbzzl_1"></i> -->
                    </div>
                    <i class="icon"></i>
                    <!-- <div id="chart-supervise" class="chart"></div> -->
            ...
            <div class="block-wrap zsdwzftj">
                ...
                <a class="echart active" href="javascript:void(0);" data-type="echart"></a>
                    ...
                    <div class="block echart-wrap" tabindex="5" style="overflow: hidden; outline: none;">
                        <div class="echart hide active" id="count-echart" _echarts_instance_="ec_1530004174194"
                             style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative;">
                            <div style="position: relative; overflow: hidden; width: 2000px; height: 320px; padding: 0px; margin: 0px; border-width: 0px; cursor: default;">
                                <canvas data-zr-dom-id="zr_0" width="2000" height="320"
                                        style="position: absolute; left: 0px; top: 0px; width: 2000px; height: 320px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas>
                            </div>
                            <div style="position: absolute; display: none; border-style: solid; white-space: nowrap; z-index: 9999999; transition: left 0.4s cubic-bezier(0.23, 1, 0.32, 1), top 0.4s cubic-bezier(0.23, 1, 0.32, 1); background-color: rgba(50, 50, 50, 0.7); border-width: 0px; border-color: rgb(51, 51, 51); border-radius: 4px; color: rgb(255, 255, 255); font-style: normal; font-variant: normal; font-weight: normal; font-stretch: normal; font-size: 14px; font-family: &quot;Microsoft YaHei&quot;; line-height: 21px; padding: 5px; left: 483px; top: 149px;">
                                Wed<br><span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#03d7b6;"></span>直接访问: 40
                            </div>
                        </div>
