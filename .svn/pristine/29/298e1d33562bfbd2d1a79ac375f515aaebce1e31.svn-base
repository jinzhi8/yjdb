...
function fHoliday(y, m, d) {
    ...
    if (m == 1 && d == 1) {
        r = ["元旦!新年快乐！ ",gsAction,"skyblue","red"];
    } else if (m == 2 && d == 14) {
        r = ["情人节",gsAction,"skyblue","red"];
    } else if (m == 3 && d == 8) {
        r = ["妇女节",gsAction,"skyblue","red"];
    } else if (m == 5 && d == 1) {
        r = ["劳动节",gsAction,"skyblue","red"];
    } else if (m == 5 && d == 4) {
        r = ["青年节",gsAction,"skyblue","red"];
    } else if (m == 6 && d == 1) {
        r = ["儿童节",gsAction,"skyblue","red"];
    } else if (m == 7 && d == 1) {
        r = ["中国共产党诞辰纪念日\n香港回归纪念日",gsAction,"skyblue","red"];
    } else if (m == 7 && d == 7) {
        r = ["七七事变纪念日",gsAction,"skyblue","red"];
    } else if (m == 8 && d == 1) {
        r = ["建军节",gsAction,"skyblue","red"];
    } else if (m == 8 && d == 15) {
        r = ["日本战败投降日",gsAction,"skyblue","red"];
    } else if (m == 9 && d == 10) {
        r = ["教师节",gsAction,"skyblue","red"];
    } else if (m == 10 && d == 1) {
        r = ["国庆节",gsAction,"skyblue","red"];
    } else if (m == 12 && d == 25) {
        r = ["圣诞节!圣诞快乐！",gsAction,"skyblue","red"];
    } else if (m == 1 && d < 25) {
