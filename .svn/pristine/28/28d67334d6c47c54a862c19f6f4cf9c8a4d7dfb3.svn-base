...
<script type="text/javascript" src="<%=contextPath%>/js/json2.js"></script>
         <table id="baseinfo" width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
                <div align="right">
                    立项编〔<html:text name="year" value="<%=info.getYear()%>" style="width:60px"/>〕<html:text name="num"
                    value="<%=info.getNum()%>" style="width:50px"/>号
                </div>
            <tr VALIGN=top>
                ...
                <td class="tinttd" style="width:40%">
                    ...
                    <div id="hide_show" style="margin-left: 110;margin-top: -21;display:none">
                        <html:select name = "fkzq" value="<%=info.getFkzq()%>"   style="width:100px">
                            ...
                            <html:option value = "半月">半月</html:option>
            ...
            <tr valign="top">
                ...
                <td colspan="3" class="tinttd" >
                    ...
                    <img src="<%=request.getContextPath()%>/resources/images/actn133.gif" onclick="window.showModalDialog('<%=request.getContextPath()%>/address/mailboxtree.jsp?utype=1&sflag=0&count=1&ptype=1&fields=managedepname,managedepid',window,'status:no;dialogWidth:670px;dialogHeight:520px;scroll:no;help:no;')">
            ...
            <tr valign="top" style="display: none">
                ...
                <td class="tinttd">
                    <html:text name="lxr" style="width:70%"/>(督办科填写)
                </td>
                <td width="80px" VALIGN=middle class="deeptd">
                    <div align="center">电话号码</div>
                </td>
                <td class="tinttd">
                    <html:text name="lxdh" style="width:70%"/>(督办科填写)
                </td>
            </tr>
            <tr valign="top" style="display: none">
                <td width="80px" VALIGN=middle class="deeptd">
                ...
                <td   class="tinttd">
                    <html:text name="czhm" style="width:70%"/>(督办科填写)
                </td>
                <td width="80px" VALIGN=middle class="deeptd">
        ...
        <br/>
            <div height="50px"   align="center">     
                <input class="viewbutton"  type="button" onclick="if(validateForm()){insertDetail();}"  value="交督办科督办"/>  
            </div>
...
function insertDetail(){
    ...
    var qfmanid=$('[name=qfmanid]').val();
        $.ajax({ 
                async: true, 
                type : "POST", 
                url : "<%=request.getContextPath()%>/getshou/insertAjax.jsp?",
                cache: false,                      
                data : {
                    docunid:docunid,
                    userID : userID,
