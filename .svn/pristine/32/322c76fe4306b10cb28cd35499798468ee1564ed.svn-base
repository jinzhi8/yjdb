...
layui.use(['form','layer','laydate','table','laytpl','jquery','upload'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {title: '办件名称', minWidth:300,templet:'#titleTpl',style:'cursor:pointer',event:'titleClick'},
            {field: 'bh', title: '编号',width:'10%',sort: true, align:'center'},
            {field: 'name', title: '用户',width:'10%',sort: true, align:'center'},
            {field: 'state', title: '办件状态',width:'10%',sort: true,align:'center',templet:"#state"},
            {field: 'createtime', title: '发布时间',width:'10%',sort: true, align:'center'},
            {title: '操作',  width:'8%', templet:'#newsListBar',align:"center"}
        ]]
    });
    ...
    table.on('tool(newsList)', function(obj){
        ...
        if(layEvent === 'edit'){ //编辑
            ...
            parent.addTab($('<a data-url="'+ getRootPath() +'/yj_dbhf/fkShow.jsp?unid='+ data.unid +'&deptid='+data.deptid+'&v=1"><i class="layui-icon" data-icon=""></i><cite>回复情况</cite></a>'));
        } 
    });
