		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" class="round" style="width:100%;height:100%">
			<tr>
				<td class="left_col" width="180px" valign="top">
					<iframe frameborder="0" scrolling="auto" width="100%" height="100%" name="mframe" src="nav2.jsp"></iframe>
				</td>
				<td valign="top">
					<!--end content-->
					<iframe frameborder="0" scrolling="yes" width="100%" height="100%" name="cframe" src="applet2.jsp"></iframe>
				</td>
			</tr>
		</table>
		</body>
