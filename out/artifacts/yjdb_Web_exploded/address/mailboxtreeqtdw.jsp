...
//加载本单位人员列表你       chenqiang 20130929  解决全选项丢失的BUG
function bendanweirenyuan(){	
		//本单位人员
	$.post("<%=request.getContextPath()%>/address/jsontree.do",{id:"",type:"1",range:"<%=groupID%>"},function(result){
		...
		setting1.view.addDiyDom = function (treeId, treeNode) {
			if (treeNode.parentNode && treeNode.parentNode.label!='') return;
			var aObj = $("#" + treeNode.tId + IDMark_A);
			if (treeNode.isParent) {
...
//加载全县单位列表
function quanxiandanwei(){
	//因为代码逻辑不常规，执行操作在内部延迟0.5秒 加载本单位人员列表
	//setTimeout('bendanweirenyuan();',500);		
		//全部单位
...
//加载群组列表
function qunzu(){
//因为代码逻辑不常规，执行操作在内部延迟0.5秒 加载全县人员列表
	setTimeout('quanxianrenyuan();',500);		
		//群组
...
$(document).ready(function(){
	...
	//reloadSelection();
	//showChecked();
	//加载全县单位列表  因为代码逻辑不常规，执行操作在内部加载本单位人员列表
	quanxiandanwei();
	//加载群组列表   因为代码逻辑不常规，执行操作在内部加载全县人员列表
	//qunzu();
...
<div id="tabbed_box" class="tabbed_box">
	<div class="tabbed_area">
		<ul class="tabs">
			<!-- <li><a href="#" hidefocus="true" idx="content_1" class="tab active">本单位人员</a></li> -->
			<!-- <li><a href="#" hidefocus="true" idx="content_2" class="tab">全县人员</a></li> -->
			<li><a href="#" hidefocus="true" idx="content_1" class="tab">全县单位</a></li>
			<!-- <li><a href="#" hidefocus="true" idx="content_4" class="tab">群组</a></li> -->
			<!--<li><a href="#" hidefocus="true" idx="content_5" class="tab">角色</a></li>-->
		</ul>
		<!-- <div id="content_1" class="content">
			<ul id="ztree1" class="ztree" style="height:100%; width:100%;overflow:auto;"></ul>
		</div> -->
		<!-- <div id="content_2" class="content">
			<ul id="ztree2" class="ztree" style="height:100%;width:100%;overflow:auto;"></ul>
		</div> -->
		<div id="content_1" class="content">
			<ul id="ztree1" class="ztree" style="height:100%;width:100%;overflow:auto;"></ul>
		</div>
		<!-- <div id="content_4" class="content">
			<ul id="ztree4" class="ztree" style="height:100%;width:100%;overflow:auto;"></ul>
		</div> -->
		<!--
