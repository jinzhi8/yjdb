            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="table"
                ...
                <TR>
                    <TD width="90%" class="tinttd"
                        ...
                        <%--<% if("1".equals(type)) { %>
                        <li><b><font color=red size="3px"><font color=red>4.模板文件下载：</font></b><a href="<%=request.getContextPath()%>/resources/xls/会议件模板.xls" ><img
                                src="<%=request.getContextPath()%>/resources/images/text.gif"/>
                                </a>
                        <% }else{ %>
                        <li><b><font color=red size="3px"><font color=red>4.模板文件下载：</font></b><a href="<%=request.getContextPath()%>/resources/xls/其它件模板.xls" ><img
                                src="<%=request.getContextPath()%>/resources/images/text.gif"/>
                        </a>
                        <% } %>--%>
                       <b><font color=red size="3px"><font color=red>模板文件下载：</font></b><a href="<%=request.getContextPath()%>/resources/xls/会议类模板.xls"><img
...
<script type="text/javascript">
    ...
    layui.use(['layer', 'jquery', 'upload'], function () {
        ...
        upload.render({
            elem: '#pldr'
            , url: 'action/tableAction.jsp?status=import&type=<%=type%>'
            , exts: 'xls'
            , accept: 'file' //普通文件
