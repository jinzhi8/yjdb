...
var gsOutOfRange = "对不起, 你不能超出指定的日期范围!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom = "<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"你不能够选择今天!\");return false;' onmouseover='return true;' >今天 : " + gMonths[gToday[1] - 1] + " " + gToday[2] + ", " + gToday[0] + "</A>";	// the content of the bottom section.
...
var gsTodayTip = "今天";	// tooltip for today
