...
var getHtml=function(date,id){
    ...
    if(!!window.ActiveXObject&&!window.XMLHttpRequest){
        html+='<span  class="index_ico" style="vertical-align:middle;display:inline-block;width:24px;height:20px; FILTER: progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+getImg(date.icon[0])+'\', sizingMethod=\'scale\');" ></span>';
        if(len>1&&date.icon[0].substring(1,2)!=date.icon[1].substring(1,2)){
            html+='<span  class="index_ico" style="vertical-align:middle;display:inline-block;width:24px;height:20px;FILTER: progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+getImg(date.icon[1])+'\', sizingMethod=\'scale\');" ></span>';
        }
    }else{
