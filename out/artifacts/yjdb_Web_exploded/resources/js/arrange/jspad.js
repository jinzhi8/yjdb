...
//
    ...
    function drawCal(firstDay, lastDate, monthName, year) {
            ...
            var dayCellHeight = 10   // height of cells containing days of
										// the week
            var dayColor = "darkblue" // color of font representing week days
            var cellHeight = 72  // height of cells representing dates in the
									// calendar
            var todayColor = "red" // color specifying today's date in the
									// calendar
            var timeColor = "purple" // color of font representing current
										// time
...
for (var row = 1; row
    ...
    break
        ...
        // text += '<TD HEIGHT=' + cellHeight + '><div id="d'+digit
                ...
                text += '<div id="d'+year+'-'+amonth+'-'+adigit
				text+='"><a href="arrange.jsp?year='+year+'&month='+month+'&day='+digit+'&share='+share+'" ><font size=5 color='+showcolor+'>' + digit + '</font><br>'+kingfort+'</a></div></TD>'
                digit++
                }
                }
                text += '</TR>'
...
for (var row = 1; row
    ...
    tds+='<td height="23" width="48"><a href=arrange.jsp?year='+year+'&month='+i+'&share='+share+'>'+getcnMonthName(i)+'</a></td>'
    }
    tables+=tds+'</tr></table>'
...
function printDayTodo() {
    ...
    // tables+='<tr bgcolor=#dddddd height=10px><td align=middle
	// width=42>'+ls+'>其它</a></td><td width="182"><div
	// id=tt>&nbsp;</div></td></tr>'
    tables += "</table>"
    document.write(tables)
}
