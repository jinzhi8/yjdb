...
<body topmargin="1" leftmargin="3" width="996">

<table cellpadding="0" cellspacing="0" width="980" align="center" style="BORDER-left: #cccccc 4px solid;BORDER-right: #cccccc 4px solid;BORDER-bottom: #cccccc 4px solid;BORDER-top: #cccccc 4px solid;background-color:DDDDDD" background="<%=request.getContextPath()%>/resources/theme/images/yj.jpg">
<tr>
	<td valign="top"><img src="<%=request.getContextPath()%>/resources/theme/images/top.jpg"></td>
</tr>
<tr>
<tr>

<td>
<table border="0" width="980" height=1 cellspacing="0" cellpadding="0" align=center style="BORDER-left: #cccccc 2px solid;BORDER-right: #cccccc 2px solid;BORDER-bottom: #cccccc 2px solid;BORDER-top: #cccccc 2px solid">
	<tr bgcolor="#FFFFFF">
		...
		<td align="right" valign="baseline">
			<div align="right">
				...
				<img src="<%=request.getContextPath()%>/resources/theme/images/bgpt_menu_icon4.gif" width="15" height="12">
				<a href="<%=request.getContextPath()%>/logout.jsp"><font color="#000000">退出系统</font></a>
				　<img src="<%=request.getContextPath()%>/resources/theme/images/bgpt_menu_icon5.gif" width="15" height="12">
...
<table border="0" width="980" height="1" cellspacing="0" cellpadding="0" align=center>
<tr>
	<td height=4></td>
</tr>
<tr>
...
<td width="121" valign=top align=center>
	<table border="0" width="121" height=1 cellspacing="0" cellpadding="0" align=center>
		<tr>
			<td height=24 background="<%=request.getContextPath()%>/img/men.gif" align="center" width="121">&nbsp;<b><%=userName%>
			</b></td>
		</tr>
		<tr>
			<td height=5 width="top"></td>
		</tr>
		<tr>
			<td height=23 background="<%=request.getContextPath()%>/img/tool_top.gif" width="121"><b>&nbsp;应用模块导航</td>
		</tr>
		<tr>
			<td height=280 class=tool align=left valign="top" width="121">
				<table align="center">
					...
					<tr>
						<td width="120" align="left" background="<%=request.getContextPath()%>/resources/images/ben.gif" height="26">
							<img src="<%=request.getContextPath()%>/resources/images/ss.gif">&nbsp;≡<font color="#333333">
						...
						<td valign="top" align="left">
							<div id="submenu<%=i%>" style="display:none">
								<table>
									...
									<tr>
										<td align="left" valign="top" style="BORDER-bottom: #cccccc 1px solid">&nbsp;<IMG border=0 src="<%=request.getContextPath()%>/resources/images/dian.gif" valign="middle"><a href="<%=submenuLink%>">&nbsp;<font color="#333333"><%=submenuName%>
										</font></a></td>
									</tr>
									<% }%>
								</table>
		...
		<tr>
			<td height=25 background="<%=request.getContextPath()%>/img/tool_top.gif" width="121"><b>&nbsp;最新天气情况</td>
		</tr>
		<tr>
			<td height=160 class=tool valign="top" width="121">&nbsp;

				<table border="0" class="position_table" cellSpacing=0 cellPadding=0 align="center" width="121">
					<tr class="menu">
						<td class="position_td" width="121" style="width:121px" valign="top">
							<% String weathertext = "";
								try {
							...
							<marquee id="weather" behavior=scroll direction=up width=121 height="190" scrollamount=1 scrolldelay=1 onmouseover='this.stop()' onmouseout='this.start()'></marquee>
							<script language="JavaScript">
								html = '<%=weathertext%>';
...
<td width="5"></td>
<td valign="top" width="718" align="center" align="center">
	<table width="718" cellpadding="0" cellspacing="0" align="center">
		<tr>
			<td valign="top" height="1" align="center"><template:get name='content'/>
	...
	<table border="0" width=100% height=1 cellspacing="0" cellpadding="0" align=center>
		...
		<tr>
			<td height=120 class=tool align=center>
				<iframe height="150" src="<%=request.getContextPath()%>/sharebulletin/info.jsp" width="120" frameBorder="0" scrolling="no"></iframe>
			</td>
		</tr>
		<tr>
			<td height=1><img src="<%=request.getContextPath()%>/img/tool_bot.gif"></td>
		...
		<tr>
			<td height=180 class=tool valign="top" width="121">
				<table border="0" width=100% height=1 cellspacing="4" cellpadding="0" width="121">
					<tr>
						<td valign="top">
							<font color="#333333">
								<%=leftdivstr%>
		...
		<tr>
			<td height=23 background="<%=request.getContextPath()%>/img/tool_top.gif" width="121"><b>&nbsp;常用工具</td>
		</tr>
		<tr>
...
<table align="center" width="996" background="<%=request.getContextPath()%>/resources/theme/images/xia.jpg" style="BORDER-left: #cccccc 1px solid;BORDER-right: #cccccc 1px solid" height="70">
	<tr>
		<td align="center" valign="top">温州市卫生局网络协同办公平台</td>
	</tr>
</table>
<% } catch (Exception ee) {
	ee.printStackTrace();
