...
<%
	...
	if (docID != null && !"".equals(docID)) {
		...
		try {
			...
			String sql = "select * from ZWDBHY where unid = '"+docID+"'";
...
<head>
	...
	<SCRIPT LANGUAGE="JavaScript">
		...
		window.onload = function () {
			...
			TANGER_OCX_OBJ.BeginOpenFromURL(window.location.protocol + "//" + window.location.host + "<%=request.getContextPath()%>/zw_hydb/request.doc", false);
		};
	</SCRIPT>
