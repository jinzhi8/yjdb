...
<%
    ...
    String sfscfknr=request.getParameter("sfscfknr");
    ...
    ACLPRIVILELIST(unid);
      ...
      ResultSet rs=null;
      try{
        String sql="insert into ZWDB(unid,depid,depname,userid,username,title,require,leadername,source,jbsx,fklx,issuetime,qftime,managedepname,managedepid,copyto,copytoid,lxr,lxdh,czhm,issueflag,qfman,leaderid,sourceid,fkzq,year,num,isjs,qfmanid,sfscrwnr) values(?,?,?,?,?,?,?,?,?,to_date ('" + jbsx + "','yyyy-mm-dd hh24:mi:ss'),?,to_date ('" + issuetime + "','yyyy-mm-dd hh24:mi:ss'),to_date ('" + qftime + "','yyyy-mm-dd hh24:mi:ss'),?,?,?,?,?,?,?,?,?,?,?,?,?,?,'1',?,?)";
