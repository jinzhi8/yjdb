...
<%!String getFuncHTML(String id, String wid, String templatename, String layouttype, String username, String topicname, String topicurl, String align, String userflag) {
	...
	if (align.equals("left")) {
		return "<table width=\'170\'  border=\'0\'><tr><td height=\'22\' width=\'35\' align=\'right\'><img src=\'resources/images_wz/index_38.gif\' width=\'32\' height=\'25\'></td><td height=\'22\' background=\'resources/images_wz/index_49.gif\'  width=\'135\'>&nbsp;<a href=\'" + topicurl + "\' " + newWindow + ">" + topicname + "</a></td></tr></table>";
	} else {
		return " <div id=div_" + id + " style=\"width:" + wid + "px;\" class=\"drag\">\n" + " <table id=table_" + id + " width=\"100%\" border=0 align=center cellpadding=0 cellspacing=0 class=\"my_cont\">\n" + " <tr><td height=22 ><table width=\"100%\" border=0 cellspacing=0 cellpadding=0  background=\"personalize/theme/" + templatename + "/" + titlepic + "\">" + " <tr><td width=\"400\" height=22 class=my_contTitle >&nbsp;" + topicname + "</td>" + " <td height=22 align=right valign=middle >&nbsp;</td>" + " </tr></table></td></tr>" + " <tr><td valign=\"top\" height=\"" + hid + "\" align=left style=\"border: 1pt solid ;\">\n" + "<iframe id=\"" + id + "\" height=\"" + ihid + "\" src=\"" + topicurl + "\" width=\"100%\" frameBorder=\"0\" scrolling=\"no\"></iframe>" + " </td></tr></table><br></div>\n";
...
<table id="alltable" width="663" border="0" align="center" cellpadding="0" cellspacing="0" class="my_home" class="border-index">
	<tr>
		<td id="lefttd" width="185px" valign="top" bgcolor="#ECF0F4" valign="top" align="center">
			<a href="<%="/".equals(request.getContextPath())?"":request.getContextPath()%>/filebase/search.jsp"><IMG SRC="resources/images_wz/index_17.gif" width="185px" height="60" border="0"></a>
						...
						<table width="170" border="0">
							<tr>
								<td height="22" width="35" align="right">
									<img src="resources/images_wz/index_38.gif" width="32" height="25"></td>
								<td height="22" background="resources/images_wz/index_49.gif" width="135">动态信息</td>
							</tr>
						</table>
				...
				if (havedata) {
					do {
						...
						if (layouttype == 1) {
							...
							//是否功能栏目
							if (isFunc(topicid)) {
								out.print(getFuncHTML(topicid, "375", templatename, "1", usernameen, topicname, topicurl, "middle", userflag));
								havedata = rs.next();
							} else {
								havedata = rs.next();
							}
		...
		<td id="righttd" width="580" valign="top" style="padding-left:4px;padding-right:4px;padding-bottom:3px" align="center">
				...
				if (havedata) {
					do {
						...
						if (layouttype == 2) {
							...
							//是否功能栏目
							if (isFunc(topicid)) {
								out.print(getFuncHTML(topicid, "578", templatename, "2", usernameen, topicname, topicurl, "right", userflag));
								havedata = rs.next();
							} else {
								havedata = rs.next();
							}
