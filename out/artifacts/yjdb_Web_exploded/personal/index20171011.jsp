...
<template:insert template="<%=userTemplateStr%>">
	<template:put name='title' content='个人设置' direct='true'/>
	<%String str = "<a class=\"menucur\" href=\"\">个人设置</a>";%>
	...
	<template:put name='content'>
		...
		<%//页面初始化
			...
			if (viewID == null || viewID.equals(""))
				viewID = (String) request.getSession().getAttribute("personalviewid");
			String moduleIDs = "personal";
						...
						<tr>
							<td height="405" align="right" valign="top" background="<%=request.getContextPath()%>/resources/theme/images/xt_rightbg.jpg">
								<table class="view_right_link_table" height="400" border="0" cellpadding="0" cellspacing="0" background="<%=request.getContextPath()%>/resources/theme/images/xt_rightbg2.jpg">
									<tr>
										<td style="height:122px;width:189px;" align="left" valign="top" background="<%=request.getContextPath()%>/resources/theme/images/flower.jpg"></td>
									</tr>
									<tr>
